 ...
 * single-precision floats, and is stored in a short data type. To distinguish short values holding half-precision
 * floats from regular short values, it is recommended to use the <code>@HalfFloat</code> annotation.</p>
 *
...
public final class Half extends Number implements Comparable<Half> {
     ...
     */
    public static final @HalfFloat
    short EPSILON = (short) 0x1400;
     ...
     */
    public static final @HalfFloat
    short LOWEST_VALUE = (short) 0xfbff;

    /**
     * Maximum positive finite value a half-precision float may have.
     */
    public static final @HalfFloat
    short MAX_VALUE = (short) 0x7bff;

    /**
     * Smallest positive normal value a half-precision float may have.
     */
    public static final @HalfFloat
    short MIN_NORMAL = (short) 0x0400;

    /**
     * Smallest positive non-zero value a half-precision float may have.
     */
    public static final @HalfFloat
    short MIN_VALUE = (short) 0x0001;
     ...
     */
    public static final @HalfFloat
    short NEGATIVE_INFINITY = (short) 0xfc00;

    /**
     * Negative 0 of type half-precision float.
     */
    public static final @HalfFloat
    short NEGATIVE_ZERO = (short) 0x8000;

    /**
     * Positive infinity of type half-precision float.
     */
    public static final @HalfFloat
    short POSITIVE_INFINITY = (short) 0x7c00;

    /**
     * Positive 0 of type half-precision float.
     */
    public static final @HalfFloat
    short POSITIVE_ZERO = (short) 0x0000;

    private final @HalfFloat
    short mValue;
     ...
     * @see #halfToIntBits(short)
     */
    public static @HalfFloat
    short halfToShortBits(@HalfFloat short h) {
     ...
     */
    public static @HalfFloat
    short copySign(@HalfFloat short magnitude, @HalfFloat short sign) {
     ...
     */
    public static @HalfFloat
    short min(@HalfFloat short x, @HalfFloat short y) {
        return FP16.min(x, y);
    }
     ...
     */
    public static @HalfFloat
    short max(@HalfFloat short x, @HalfFloat short y) {
        return FP16.max(x, y);
    }
    ...
    Half valueOf(@HalfFloat short h) {
        return new Half(h);
    }
     ...
     */
    public static @HalfFloat
    short parseHalf(@NonNull String s) throws NumberFormatException {
